...
namespace ExcelApp.ViewModel
{
    ...
    public class MainViewModel : PaggingVM
    {
        ...
        private void OnUpdateSoftware()
        {
            ...
            AutoUpdaterDotNET.AutoUpdater.Start(link);
        }
            ...
            if (args.Error != null)
            {
                ...
                else
                {
                    MessageBox.Show(args.Error.Message,
                         args.Error.GetType().ToString(), MessageBoxButton.OK, MessageBoxImage.Error);
                }
                return;
            }
            ...
            {
                {
                    ...
                    string version = Utils.Helpers.GetCurrentVersion();
        ...
        private void OnUpdateInfo(UpdateInfoEventArgs args)
        {
            if (args == null) return;
